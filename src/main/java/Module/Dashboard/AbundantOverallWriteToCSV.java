...
public class AbundantOverallWriteToCSV extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fileName = System.getProperty("user.home") + "/Desktop/AbundantProjectDataFor" + year + ".csv";
        ...
        try {
            ...
            System.out.println("Exception at AbundantOverallWriteToCSV Servlet");
            e.printStackTrace();
        } finally {
            try {
                fileWriter.flush();
                ...
                System.out.println("IOException at AbundantOverallWriteToCSV Servlet");
                e.printStackTrace();
            }
        }
    }
